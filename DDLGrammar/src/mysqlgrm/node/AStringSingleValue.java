...
public final class AStringSingleValue extends PSingleValue
{
    private TStringLiteral _stringLiteral_;

    public AStringSingleValue()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAStringSingleValue(this);
    }
