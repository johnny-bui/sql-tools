...
public final class AReferencesClausel extends PReferencesClausel
{
    ...
    {
        ((Analysis) sw).caseAReferencesClausel(this);
    }
    ...
    public void setReferences(TReferences node)
    {
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        {
            setReferences((TReferences) newChild);
            return;
        }
